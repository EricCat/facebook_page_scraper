...
class Test_json(unittest.TestCase):
    ...
    def test_scraper_for_json(self):
        anime_group = facebook_page_scraper.Facebook_scraper("170918513059147", 5, "firefox", isGroup=True,
                                                             headless=False, username=fb_email, password=fb_password)
...
class Test_csv_output(unittest.TestCase):
    ...
    def test_csv_page(self):
        meta_page = facebook_page_scraper.Facebook_scraper("Meta", 5, "firefox", headless=False, username=fb_email,
